        ...
        categoryRepository.save(category);
            ...
            private String resolveImageUrl(String productName) {
                ...
                if (key.contains("denim")) {
                    return "https://picsum.photos/id/1062/900/900";
                }
                if (key.contains("blender") || key.contains("kitchen")) {
                    return "https://images-cdn.ubuy.co.in/693b255263e16e0e1b09fcd8-professional-blender-for-kitchen-2200.jpg";
                }
                if (key.contains("fashion")) {
                    return "https://i.pinimg.com/736x/5d/ae/0d/5dae0d6633e91bdb9e728be265c8637f.jpg";
                }
